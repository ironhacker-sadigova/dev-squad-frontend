...
const Menu = ({ history }) => (
    <div>
           ...
           <Link style={isActive(history,"/users")} to = "/users"> Developers  </Link>
            {!isAuthenticated() && (
                <>
                 <Link style={isActive(history,'/signup')} to = "/signup"> Join  </Link>
          <Link style={isActive(history,"/signin")} to = "/signin"> Members </Link>
                </> 
            )}
            {isAuthenticated() && (
                <>
